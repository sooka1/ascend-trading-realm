        ...
        <nav className="hidden items-center gap-1 lg:flex">
          {NAV.map((item) => (
            <Link
              key={item.to}
              to={item.to}
              className="rounded-md border border-primary/40 bg-white px-3 py-2 text-sm text-primary transition-colors hover:border-primary hover:bg-primary/10 hover:text-primary"
        ...
        <div className="flex flex-col gap-1 p-4">
          {NAV.map((item) => (
            <Link
              ...
              className="rounded-md border border-primary/40 bg-white px-3 py-2.5 text-sm text-primary hover:border-primary hover:bg-primary/10 hover:text-primary"
            >
              {t(item.key)}
            </Link>
          ))}

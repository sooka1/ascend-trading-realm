...
const ar: PageContent = {
  about: {
    ...
    hero: { eyebrow: "من نحن", titleA: "بُنيت بأيدي المتداولين،", titleB: "لأجل المستثمرين", subtitle: "تأسست في 2019، وتجمع HK Global Trading بين التنفيذ المؤسسي ومنظومة مسابقات عالمية — بثقة أكثر من مليوني عميل." },

  ...
  faq: {
    ...
    groups: [
      ...
      { title: "الأمان والامتثال", items: [
        { q: "هل HKEX Invest تابعة لبورصة هونغ كونغ (HKEX)؟", a: "لا. HKEX Invest منصة تكنولوجيا مالية مستقلة وليست تابعة لـ Hong Kong Exchanges and Clearing Limited (HKEX) ولا معتمدة منها ولا تعمل تحت إدارتها." },
        { q: "كيف يتم فصل أموال العملاء؟", a: "تُدار أرصدة العملاء في حسابات مخصصة ومنفصلة تشغيليًا عن الأموال العاملة للشركة. مزيد من التفاصيل في صفحة الأمان." },
        { q: "هل تدعمون المصادقة الثنائية؟", a: "نعم — يمكن تفعيل المصادقة الثنائية (TOTP) من إعدادات الأمان في حسابك." },
      ]},
    ],
  },
  markets: {

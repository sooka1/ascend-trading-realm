...
const ar: PageContent = {
  about: {
    ...
    hero: { eyebrow: "من نحن", titleA: "استثمر أموالك…", titleB: "واترك التداول للمحترفين.", subtitle: "فريق من المتداولين المحترفين يدير عمليات التداول باستخدام استراتيجيات مدروسة وإدارة مخاطر دقيقة، لتتمكن من الاستثمار دون الحاجة إلى تعلم التداول أو متابعة الأسواق بنفسك.\nتأسست في 2019، وتجمع HK Global Trading بين التنفيذ المؤسسي ومنظومة مسابقات عالمية — بثقة أكثر من مليوني عميل." },

...
const en: StaticPages = {
  legal: {
    ...
    sections: [
      ...
      { t: "Conflicts of interest", b: "HKEX Invest maintains policies designed to identify, mitigate and disclose conflicts of interest. Any material conflict is disclosed to affected clients in accordance with applicable rules." },
  ...
  terms: {
    ...
    sections: [
      ...
      { t: "Eligibility & account opening", b: "Services are offered subject to eligibility, jurisdictional restrictions and successful KYC/AML verification. HKEX Invest may decline or terminate services at its discretion in accordance with law." },
      ...
      { t: "Intellectual property", b: "All content on this site is the property of HKEX Invest or its licensors and is protected by intellectual property law." },
      { t: "Limitation of liability", b: "To the maximum extent permitted by law, HKEX Invest is not liable for indirect, incidental or consequential damages arising from use of this site." },
      { t: "Governing law", b: "These terms are governed by the laws applicable in the jurisdiction of the service agreement between you and HKEX Invest." },
    ],
  },
  risk: {
...
const ar: StaticPages = {
  legal: {
    ...
    sections: [
      { t: "النهج التنظيمي", b: "تعمل HKEX Invest وفق الأطر التنظيمية المعمول بها في الولايات القضائية التي تقدّم فيها خدماتها. يخضع فتح حسابات العملاء لإجراءات التحقق من الهوية (KYC) ومكافحة غسل الأموال (AML). هذه الصفحة ملخّص ولا تُشكّل الإفصاحات التنظيمية الكاملة لأي ولاية قضائية بعينها." },
      ...
      { t: "تضارب المصالح", b: "تحتفظ HKEX Invest بسياسات مصمَّمة لتحديد وتخفيف والإفصاح عن تضارب المصالح. يُفصَح عن أي تضارب جوهري للعملاء المتأثرين وفقًا للقواعد المعمول بها." },
  ...
  terms: {
    ...
    sections: [
      ...
      { t: "الأهلية وفتح الحساب", b: "تُقدَّم الخدمات وفق الأهلية والقيود القضائية والتحقق الناجح من KYC/AML. يجوز لـ HKEX Invest رفض أو إنهاء الخدمات وفق تقديرها وطبقًا للقانون." },
      ...
      { t: "الملكية الفكرية", b: "جميع المحتويات في هذا الموقع مملوكة لـ HKEX Invest أو المرخّصين لها ومحمية بموجب قوانين الملكية الفكرية." },
      { t: "حدود المسؤولية", b: "إلى أقصى حدٍّ يسمح به القانون، لا تتحمّل HKEX Invest مسؤولية الأضرار غير المباشرة أو العرضية أو التبعية الناجمة عن استخدام هذا الموقع." },
      { t: "القانون الحاكم", b: "تخضع هذه الشروط للقوانين المعمول بها في الولاية القضائية لاتفاقية الخدمة بينك وبين HKEX Invest." },
    ],
  },
  risk: {
  ...
  solutions: {
    ...
    ctaPortfolios: "استعرض باقات الاستثمار",
...
const fr: StaticPages = {
  legal: {
    ...
    sections: [
      ...
      { t: "Conflits d'intérêts", b: "HKEX Invest applique des politiques d'identification, d'atténuation et de divulgation des conflits d'intérêts. Tout conflit important est divulgué aux clients concernés conformément aux règles applicables." },
  ...
  terms: {
    ...
    sections: [
      ...
      { t: "Éligibilité et ouverture de compte", b: "Les services sont soumis à éligibilité, restrictions juridictionnelles et vérification KYC/AML. HKEX Invest peut refuser ou résilier à sa discrétion conformément à la loi." },
      ...
      { t: "Propriété intellectuelle", b: "Tout le contenu appartient à HKEX Invest ou ses concédants et est protégé par le droit de la propriété intellectuelle." },
      { t: "Limitation de responsabilité", b: "Dans la mesure permise par la loi, HKEX Invest n'est pas responsable des dommages indirects ou consécutifs liés à l'usage du site." },
      { t: "Droit applicable", b: "Ces conditions sont régies par les lois applicables à l'accord de service entre vous et HKEX Invest." },
    ],
  },
  risk: {
...
const es: StaticPages = {
  legal: {
    ...
    sections: [
      { t: "Enfoque regulatorio", b: "HKEX Invest opera bajo los marcos regulatorios aplicables en las jurisdicciones donde presta servicios. La incorporación de clientes está sujeta a verificación KYC y AML. Esta página es un resumen y no constituye la divulgación regulatoria completa." },
      ...
      { t: "Conflictos de interés", b: "HKEX Invest mantiene políticas para identificar, mitigar y divulgar conflictos de interés. Los conflictos materiales se divulgan a los clientes afectados." },
  ...
  terms: {
    ...
    sections: [
      ...
      { t: "Propiedad intelectual", b: "Todo el contenido pertenece a HKEX Invest o sus licenciantes y está protegido por la ley de propiedad intelectual." },
      ...
      { t: "Ley aplicable", b: "Estos términos se rigen por las leyes aplicables al acuerdo de servicio entre tú y HKEX Invest." },
    ],
  },
  risk: {
...
const tr: StaticPages = {
  legal: {
    ...
    sections: [
      { t: "Düzenleyici yaklaşım", b: "HKEX Invest, hizmet verdiği yetki alanlarındaki geçerli düzenleyici çerçevelere göre faaliyet gösterir. Müşteri kabulü KYC ve AML doğrulamasına tabidir. Bu sayfa bir özettir." },
      ...
      { t: "Çıkar çatışmaları", b: "HKEX Invest, çıkar çatışmalarını tanımlayan, azaltan ve açıklayan politikalara sahiptir." },
  ...
  terms: {
    ...
    sections: [
      ...
      { t: "Fikri mülkiyet", b: "Bu sitedeki tüm içerik HKEX Invest veya lisans verenlerine aittir." },

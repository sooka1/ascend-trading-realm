      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-4 md:grid-cols-4">
          {[
            ...
            { icon: Sparkles, t: "احصل على رأسمال تجريبي", b: "يودَع في حسابك 1000$ تجريبية × مضاعف الاشتراك." },
      ...
      <section className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-6 flex items-end justify-between gap-4">
          ...
          <p className="hidden max-w-md text-xs text-muted-foreground sm:block">
            كل زيادة في رسم الاشتراك تضاعف رأس المال التجريبي وقيمة الجائزة القابلة للسحب.
          </p>
        </div>
        ...
        <div className="glass-strong rounded-3xl p-6 md:p-8">
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            {[
              ...
              "قيمة الجائزة القابلة للسحب تعادل رأس المال التجريبي (10$ → 1000$ ، 20$ → 2000$ ، وهكذا).",

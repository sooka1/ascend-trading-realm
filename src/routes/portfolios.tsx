...
const REVIEWS: Record<Lang, ReviewsContent> = {
  ar: {
    ...
    items: [
      ...
      { name: "سارة العتيبي", role: "طبيبة استشارية — الرياض", tier: "المحافظة", rating: 5, quote: "بدأت بمحفظة محافِظة والحفاظ على رأس المال كان الأولوية — الأداء تجاوز توقعاتي.", verified: true },
      { name: "أحمد الفهد", role: "مستثمر خاص — الكويت", tier: "النمو", rating: 5, quote: "محفظة النمو تناسب أفقي الاستثماري الطويل. إدارة مخاطر منضبطة وأداء قوي.", verified: true },
      { name: "ليلى القحطاني", role: "مديرة مالية — جدة", tier: "المتوازنة", rating: 4.5, quote: "التنويع بين الأصول واضح والتواصل مع المستشار احترافي جدًا.", verified: true },
      { name: "يوسف البلوشي", role: "مهندس أول — مسقط", tier: "المحافظة", rating: 5, quote: "خيار مثالي لمن يبحث عن استثمار مستقر بعيدًا عن تقلبات السوق.", verified: true },
      { name: "منى الشمري", role: "مستثمرة — الدوحة", tier: "النمو", rating: 4.5, quote: "التحديثات الأسبوعية عن الأداء ممتازة، وسحب الأرباح سهل وسريع.", verified: true },
      ...
      // — عرب —
      { name: "عبدالله الغامدي", role: "رجل أعمال — الرياض", tier: "النمو", rating: 5, quote: "خدمة عملاء راقية وتقارير أسبوعية تعطيني صورة كاملة عن المحفظة.", verified: true },
      { name: "نورة الكعبي", role: "مستثمرة — أبوظبي", tier: "المتوازنة", rating: 5, quote: "تجربة استثمارية ناضجة، والتواصل مع المستشار مباشر وواضح.", verified: true },
      { name: "فيصل الدوسري", role: "استشاري مالي — المنامة", tier: "المحافظة", rating: 4.5, quote: "الحفاظ على رأس المال أولوية، وقد لمست ذلك في كل قرار.", verified: true },
      { name: "ريم الحمادي", role: "مديرة تسويق — الشارقة", tier: "النمو", rating: 5, quote: "عوائد جيدة مع شفافية كاملة في العمولات والرسوم.", verified: true },
      { name: "ماجد الحربي", role: "طبيب — الدمام", tier: "المتوازنة", rating: 5, quote: "تنويع ذكي بين الأصول وأداء يستحق الثقة.", verified: true },
      { name: "هند الزعابي", role: "مستثمرة خاصة — عمّان", tier: "المحافظة", rating: 4.5, quote: "أشعر أن مالي في أيدٍ أمينة، والتقارير تصلني في وقتها.", verified: true },
      { name: "طارق البقمي", role: "مقاول — جدة", tier: "النمو", rating: 5, quote: "بدأت متردداً وأصبحت من أكثر المؤيدين لهذه المحفظة.", verified: true },
      { name: "دانا الصباح", role: "محامية — الكويت", tier: "المتوازنة", rating: 5, quote: "احترافية في التعامل ونتائج فعلية على أرض الواقع.", verified: true },
      // — مصريون (لهجة مصرية) —
